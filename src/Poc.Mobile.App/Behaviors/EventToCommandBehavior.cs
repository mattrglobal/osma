...
namespace Poc.Mobile.App.Behaviors
{
    public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        public bool DeselectOnClick
        {
            get { return (bool)GetValue(DeselectOnClickProperty); }
            set { SetValue(DeselectOnClickProperty, value); }
        }
        ...
        void RegisterEvent(string name)
        {
            ...
            if (eventInfo == null)
            {
                throw new ArgumentException(
                    string.Format("EventToCommandBehavior: Can't register the '{0}' event.",
                    EventName)
                );
            }
